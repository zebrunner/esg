...
func init() {
	...
	flag.IntVar(&config.MinMemory, "min-memory", 1536, "AWS minimum memory limitation for session")
	flag.IntVar(&config.MinMemoryReservation, "min-memory-reservation", 1536, "AWS minimum memory reservation limitation for session")
