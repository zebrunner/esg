...
func buildPlaywright(workspace string, routerUUID string, image images.Image, caps *capabilities.Capabilities) (*ExecutionEnvironment, error) {
	...
	browserContainer := Container{
		...
		Ports: map[string]portMapping{
			"driver":         {ContainerPort: playwrightPort, HostPort: playwrightPort},
			"control":        {ContainerPort: playwrightControlPort, HostPort: playwrightControlPort},
			"vnc":            {ContainerPort: vncPort, HostPort: vncPort},
			"devtools":       {ContainerPort: playwrightCdpPort, HostPort: playwrightCdpPort},
	...
	recorderContainer := Container{
		...
		Essential:  false,
		Ports: map[string]portMapping{
			"recorder": {ContainerPort: recorderdPort, HostPort: recorderdPort},
		},
		Env: map[string]string{
	...
	env := ExecutionEnvironment{
		...
		Network: &network.NetworkConfiguration{
			...
			Endpoints: map[string]*network.Endpoint{
				"driver":            {ContainerPort: playwrightPort, HostPort: playwrightPort, Path: "/"},
				"playwrightRefresh": {ContainerPort: playwrightControlPort, HostPort: playwrightControlPort, Path: "/refresh"},
				"playwrightHealth":  {ContainerPort: playwrightControlPort, HostPort: playwrightControlPort, Path: "/health"},
				"vnc":               {ContainerPort: vncPort, HostPort: vncPort, Path: "/"},
				"devtools":          {ContainerPort: playwrightCdpPort, HostPort: playwrightCdpPort, Path: "/"},
				...
				"healthcheck":       {ContainerPort: playwrightCdpPort, HostPort: playwrightCdpPort, Path: "/"},
				...
				"recorderRotate":    {ContainerPort: recorderdPort, HostPort: recorderdPort, Path: "/rotate"},
