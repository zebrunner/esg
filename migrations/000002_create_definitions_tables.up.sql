...
CREATE TABLE IF NOT EXISTS definitions(
    register_definition_hash VARCHAR(64) PRIMARY KEY NOT NULL,
    revision_tag INTEGER NOT NULL,
    updated_at TIMESTAMP,
    override_definition_hash VARCHAR(64) NOT NULL,
...
CREATE UNIQUE INDEX definitions_override_hash_unique ON definitions (override_definition_hash);
